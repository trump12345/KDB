...
% 	class_node is the class node   类节点
% 	root is the root node of the tree part of the dag (must be different from the class node)根节点
%   	node_sizes = 1 if gaussian node,
%   	scoring_fn = 'bic' (default value) or 'mutual_info'评价指标默认'bic'
%
% Output :
